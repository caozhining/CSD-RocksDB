...
ops_path="./csd4+4threads_ops.csv"
echo $ops_path
report_path="./csd4+4threads_top.txt"
echo $report_path
log_path="./csd4+4threads_log.txt"
echo $log_path
/home/zhining/rocksdb-9.0.0-RAID/db_bench --db=/mnt/smartssd3/czn/rocksdb_array_cpu --benchmarks="fillrandom,stats" --num=500000000 --compression_type=None --key_size=24 --value_size=1024 --format_version=5 --max_background_compactions=20 --max_background_jobs=21 --target_file_size_multiplier=1 --subcompactions=1 --max_background_flushes=-1 --stats_dump_period_sec=120 --open_files=500 --report_interval_seconds=1 --report_file=$ops_path > $log_path &
while true; do
