...
// Current the following isn't equivalent to OS_LINUX.
 ...
 public:
  ...
  std::cout<<"======================================\n";
    ...
    std::cout<<"Before Print Header\n";

    PrintHeader(open_options_);

    uint64_t target_size = 256 * 1024 * 1024 * 1024;
    open_options_.cf_paths = {
      DbPath("/mnt/smartssd0/czn/raid_csd_test0",target_size),
      DbPath("/mnt/smartssd1/czn/raid_csd_test1",target_size),
      DbPath("/mnt/smartssd2/czn/raid_csd_test2",target_size),
      DbPath("/mnt/smartssd3/czn/raid_csd_test3",target_size),
    };

    std::cout<<"SETTING CF_PATH\n";
    ...
    while (std::getline(benchmark_stream, name, ',')) {
      ...
      if (name == "fillseqdeterministic" ||
        ...
        else if (open_options_.compaction_csd_policy == kCompactionLessThan4)
        {
 ...
 private:
  ...
  void InitializeOptionsGeneral(Options* opts) {
    ...
    // options.CompactionKernelPath="/home/yjr/projects/compaction_varkey/build_dir.hw.xilinx_u2_gen3x4_xdma_gc_2_202110_1/compaction_k32v1024_rprepair_20250616.xclbin";
    // // open_options_.CompactionKernelPath="/home/yjr/projects/compaction_varkey/build_dir.hw.xilinx_u2_gen3x4_xdma_gc_2_202110_1/compaction_k32v512_20250609.xclbin";
    // // open_options_.CompactionKernelPath="/home/yjr/projects/compaction_varkey/build_dir.hw.xilinx_u2_gen3x4_xdma_gc_2_202110_1/compaction_k32v256_20250609.xclbin";
    // options.Compaction_accelerator_id.resize(4);
    // options.Compaction_accelerator_id= {1, 0, 2, 3};
    // options.compaction_csd_gen_sst_file_size_policy=KCompactionCSDSSTlayer;
  ...
  void Open(Options* opts) {
    if (!InitializeOptionsFromFile(opts)) {
      printf("before open flags\n");
      InitializeOptionsFromFlags(opts);
    }
    printf("before general\n");
