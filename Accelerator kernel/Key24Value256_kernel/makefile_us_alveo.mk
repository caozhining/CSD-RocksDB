...
# Kernel compiler global settings
VPP_FLAGS += -D KERNEL_NAME=krnl_vadd
VPP_LDFLAGS_vadd += --config ./krnl_vadd.cfg
VPP_FLAGS += --hls.clock 100000000:krnl_vadd

# Kernel linker flags
# VPP_LDFLAGS_adder += --config ./vda.cfg # 内核配置文件
VPP_LDFLAGS_adder += --kernel_frequency 100
